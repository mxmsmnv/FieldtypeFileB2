...
/**
 * ProcessWire File Fieldtype for Backblaze B2
 *
 * Field that stores one or more files with optional description on Backblaze B2.
 *
...
class FieldtypeFileB2 extends FieldtypeFile {
    ...
    public function ___uninstall() {
		parent::___uninstall();
		$this->modules->uninstall("InputfieldFileB2");
    }
